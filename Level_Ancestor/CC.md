...
![number of good paths cont1](https://latex.codecogs.com/svg.latex?=\frac{(2n-2)!}{(n-1)!(n-1)!}[1-\frac{n-1}{n}])  
![number of good paths cont2](https://latex.codecogs.com/svg.latex?=\frac{1}{n}\binomial{2(n-1)}{n-1})  
