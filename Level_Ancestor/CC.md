...
![#good](https://render.githubusercontent.com/render/math?math=\text{#good}=C_{n-1}^{2(n-1)}-\text{#bad})  
...
![#bad](https://render.githubusercontent.com/render/math?math=\text{#bad}=C_{n-2}^{2(n-1)})  
