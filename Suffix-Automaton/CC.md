...
<i>Suffix(w)</i> = {&beta; &isin; &Sigma;* | &exist; &alpha;: &alpha;&beta; = w}  
...
<i>Σ<sub>0 ≤ i < |w|</sub> (1 + |SC<sub>w<sub>i</sub></sub>(w<sub>i</sub>)| - |SC<sub>w<sub>i + 1</sub></sub>(w<sub>i + 1</sub>)| = |w| + |SC<sub>w<sub>0</sub></sub>(w<sub>0</sub>)| - |SC<sub>w</sub>(w)| ≤ |w| + 1 <i>c O(|w|)</i>
